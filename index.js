...
const uri = "mongodb+srv://foadata:roBZiRKNJ68qhM7W@cluster0.mdvmm9t.mongodb.net/?retryWrites=true&w=majority";
console.log(uri)
...
async function run() {
    try {
        ...
        const homebannerCollection = client.db("foaDatabase").collection("homebanner")
        const provideSolutionCollection = client.db("foaDatabase").collection("providesolution")
        const homeaboutusCollection = client.db("foaDatabase").collection("homeAboutus")
        const facehomeCollection = client.db("foaDatabase").collection("facehomedata")
        const choosedataCollection = client.db("foaDatabase").collection("choosedata")
        const testimonialCollection = client.db("foaDatabase").collection("home_testimonial")
        const getinTouchCollection = client.db("foaDatabase").collection("home_getintouch")
        ...
        const servicebannerCollection = client.db("foaDatabase").collection("service_banner")
        const processServiceCollection = client.db("foaDatabase").collection("service_processService")
        const servicedesignToolCollection = client.db("foaDatabase").collection("service_designTools")
        const servicePartnerCollection = client.db("foaDatabase").collection("service_partner")
        const serviceQuestionCollection = client.db("foaDatabase").collection("service_question")
        const serviceprovideCollection = client.db("foaDatabase").collection("service_provide")
...
app.put("/bannerupdate/:id", async (req, res) => {
  ...
  const result=await homebannerCollection.updateOne(filter,updateDoc,options);
...
app.put("/provideupdate/:id", async (req, res) => {
  ...
  const result=await provideSolutionCollection.updateOne(filter,updateDoc,options);
  console.log('uodateinf',id);
  res.json(result)
...
app.put("/homeaboutusupdate/:id", async (req, res) => {
  ...
  const result=await homeaboutusCollection.updateOne(filter,updateDoc,options);
  console.log('uodateinf',id);
  res.json(result)
...
app.put("/chooseupdate/:id", async (req, res) => {
  ...
  const updateDoc={
      $set:{
        contentSectionWhyChoseUSText: updateUser.contentSectionWhyChoseUSText,
...
app.put("/testimonialupdate/:id", async (req, res) => {
  ...
  const updateDoc={
      $set:{
        TestimonialContentSectionText: updateUser.TestimonialContentSectionText,
        TestimonialThumbnailText: updateUser.TestimonialThumbnailText,
...
app.put("/footerupdate/:id", async (req, res) => {
  ...
  const result=await footerCollection.updateOne(filter,updateDoc,options);
  console.log('uodateinf',id);
  res.json(result)
...
app.put("/servicebannerupdate/:id", async (req, res) => {
  ...
  const result=await servicebannerCollection.updateOne(filter,updateDoc,options);
  console.log('uodateinf',id);
  res.json(result)
...
app.put("/processServiceupdate/:id", async (req, res) => {
  ...
  const result=await processServiceCollection.updateOne(filter,updateDoc,options);
  console.log('uodateinf',id);
  res.json(result)
...
app.put("/designToolupdate/:id", async (req, res) => {
  ...
  const result=await servicedesignToolCollection.updateOne(filter,updateDoc,options);
  console.log('uodateinf',id);
  res.json(result)
...
app.put("/partnerupdate/:id", async (req, res) => {
  ...
  const result=await servicePartnerCollection.updateOne(filter,updateDoc,options);
  console.log('uodateinf',id);
  res.json(result)
...
app.put("/questionupdate/:id", async (req, res) => {
  ...
  const result=await serviceQuestionCollection.updateOne(filter,updateDoc,options);
  console.log('uodateinf',id);
  res.json(result)
...
app.put("/serviceprovideupdate/:id", async (req, res) => {
  ...
  const updateDoc={
      $set:{
        tittleOne: updateUser.tittleOne,
        tittletwo: updateUser.tittletwo,
        tittleshortword: updateUser.tittleshortword,
        details: updateUser.details,
  ...
  const result=await serviceprovideCollection.updateOne(filter,updateDoc,options);
  console.log('uodateinf',id);
  res.json(result)
...
app.delete('/bannersdelete/:id',async(req,res)=>{
  const result= await homebannerCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
app.delete('/deleteHomeaboutus/:id',async(req,res)=>{
  const result= await homeaboutusCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
app.delete('/deleteHomeChoose/:id',async(req,res)=>{
  const result= await choosedataCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
app.delete('/provideDelete/:id',async(req,res)=>{
  const result= await provideSolutionCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
app.delete('/facehomeDelete/:id',async(req,res)=>{
  const result= await facehomeCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
app.delete('/testimonialDelete/:id',async(req,res)=>{
  const result= await testimonialCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
app.delete('/getintouchDelete/:id',async(req,res)=>{
  const result= await getinTouchCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
...
app.delete('/footerDelete/:id',async(req,res)=>{
  const result= await footerCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
app.delete('/servicebannerDelete/:id',async(req,res)=>{
  const result= await servicebannerCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
app.delete('/designtoolDelete/:id',async(req,res)=>{
  const result= await servicedesignToolCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
app.delete('/partnerDelete/:id',async(req,res)=>{
  const result= await servicePartnerCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
app.delete('/questionDelete/:id',async(req,res)=>{
  const result= await serviceQuestionCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
// delete 
app.delete('/serviceprovideDelete/:id',async(req,res)=>{
  const result= await serviceprovideCollection.deleteOne({_id:ObjectId(req.params.id)});
  res.json(result)
});
